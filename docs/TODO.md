...
- [x] **Frontend Job Polling Polish:** Enhance the Next.js polling logic to use WebSockets or more robust state management (e.g., React Query) for a smoother user experience.
- [x] **K8s Ingress Configuration:** Define Ingress resources to expose the Next.js frontend and FastAPI backend via a unified load balancer.
