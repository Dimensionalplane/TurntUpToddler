...
- [ ] Exposing deep TTS parameters (voice_id, model selection) to the frontend CLI and UI.
- [ ] Implement global, file-based version tracking referencing the omni-workspace `VERSION` file.

## Phase 3: Scaling & Platform Expansion
- [ ] Support for multiple input formats beyond MIDI (MusicXML, sheet music PDFs via OMR).
- [ ] TikTok/Instagram Reels native vertical video formatting.
